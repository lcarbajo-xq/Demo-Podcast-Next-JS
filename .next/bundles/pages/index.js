...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_components_channel_grid__ = __webpack_require__("./src/components/channel-grid.js");
...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__src_components_layout__["a" /* default */], {
        title: "Podcasts | Inicio",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 27
        }
      }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__src_components_channel_grid__["a" /* default */], {
        channels: channels,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 28
...
__WEBPACK_IMPORTED_MODULE_5_next_router___default.a.events.on('routeChangeStart', function (url) {
  __WEBPACK_IMPORTED_MODULE_4_nprogress___default.a.start();
});
__WEBPACK_IMPORTED_MODULE_5_next_router___default.a.events.on('routeChangeComplete', function () {
  return __WEBPACK_IMPORTED_MODULE_4_nprogress___default.a.done();
});
__WEBPACK_IMPORTED_MODULE_5_next_router___default.a.events.on('routeChangeError', function () {
  return __WEBPACK_IMPORTED_MODULE_4_nprogress___default.a.done();
});
